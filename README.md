...
- Quick Link: `#5`
- Partial Link: `step-security/dependencies-action#5`
- Partial URL: `step-security/dependencies-action/pull/5`
- Full URL: `https://github.com/step-security/dependencies-action/pull/5`
- Markdown: `[markdown link](https://github.com/step-security/dependencies-action/pull/5)`
